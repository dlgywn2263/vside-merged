...
// 경로: src/components/design/realtime/snapshotWriter.ts
//
// 설계 문서를 서버에 남기는 담당자.
//
...
export class SnapshotWriter {
   ...
   * 떠나기 직전에 저장하고 갈 사람인지.
   *
   * 연결을 끊고 나면 담당자를 판단할 근거(누가 접속해 있는지)가 사라져
   * 모두가 자기를 담당이라고 여기게 된다. 그러면 나가는 사람마다 저장을
   * 보내면서, 남아서 계속 편집하던 팀원의 최신 상태를 옛 내용으로 덮을 수
   * 있다. 그래서 연결을 끊기 <b>전에</b> 물어본다.
   */
